...
[task_local]
#半点红包雨
30 0-23 * * * https://raw.githubusercontent.com/ljqailym/JD/main/jd_live_redrain_half.js, tag= =半点红包雨, enabled=true
===========Loon============
[Script]
cron "30 0-23 * * *" script-path=https://raw.githubusercontent.com/ljqailym/JD/main/jd_live_redrain_half.js,tag=半点红包雨
============Surge=============
半点红包雨 = type=cron,cronexp="30 0-23 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/ljqailym/JD/main/jd_live_redrain_half.js.js
==========小火箭========
半点红包雨 = type=cron,script-path=https://raw.githubusercontent.com/ljqailym/JD/main/jd_live_redrain_half.js, cronexpr="30 0-23 * * *", timeout=3600, enable=true
*/
const $ = new Env('半点红包雨');
...
let ids = {
  ...
  '20': 'RRA3U4e4F1fxoo2bUatuvrQpBTBXDpV',
