...
[task_local]
#店铺签到
0 0 * * * https://raw.githubusercontent.com/ljqailym/JD/main/dpqd3.js, tag=店铺签到, enabled=true
===========Loon============
[Script]
cron "0 0 * * *" script-path=https://raw.githubusercontent.com/ljqailym/JD/main/dpqd3.js,tag=店铺签到
============Surge=============
店铺签到 = type=cron,cronexp="0 0 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/ljqailym/JD/main/dpqd3.js
===========小火箭========
店铺签到 = type=cron,script-path=https://raw.githubusercontent.com/ljqailym/JD/main/dpqd3.js, cronexpr="0 0 * * *", timeout=3600, enable=true
*/
...
let shopname=''
const token=[
 'D0A3260C33D0697F252F95083B062C12',//3天100豆4.18
 '4D03AD91B666A22112A8907AE843A2AC',//3天100豆4.18
]
//IOS等用户直接用NobyDa的jd cookie
