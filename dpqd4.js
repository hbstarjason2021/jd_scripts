...
[task_local]
#店铺签到
0 0 0 * * * https://raw.githubusercontent.com/ljqailym/JD/main/dpqd4.js, tag=店铺签到, enabled=true
===========Loon============
[Script]
cron "0 0 0 * * *" script-path=https://raw.githubusercontent.com/ljqailym/JD/main/dpqd4.js,tag=店铺签到
============Surge=============
店铺签到 = type=cron,cronexp="0 0 0 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/ljqailym/JD/main/dpqd4.js
===========小火箭========
店铺签到 = type=cron,script-path=https://raw.githubusercontent.com/ljqailym/JD/main/dpqd4.js, cronexpr="0 0 0 * * *", timeout=3600, enable=true
*/
...
let shopname=''
const token=[
 '155D1C760ABC76011971C1B6915BAD59',//3天100豆4.18
