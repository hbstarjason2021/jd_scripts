...
let shareCodes = [ // 这个列表填入你要助力的好友的shareCode
  ...
  //'568a5e8a38a74c1c9ef91043b6b252c2@da165e02f62c4ca8aed3432a3be43851@c946104ab47c464ab13f68ee6903cdf7@2a21521982d34c00acc624b867fe1ec4',
  $.getdata('fruitShareCode1'),
  //账号二的好友shareCode,不同好友的shareCode中间用@符号隔开
  //'568a5e8a38a74c1c9ef91043b6b252c2@da165e02f62c4ca8aed3432a3be43851@c946104ab47c464ab13f68ee6903cdf7@2a21521982d34c00acc624b867fe1ec4',
  $.getdata('fruitShareCode2')
]
console.log($.getdata('fruitShareCode1'));
...
async function jdFruit() {
  ...
  if ($.farmInfo.farmUserPro) {
    ...
    $.get({url: `http://api.turinglabs.net/api/v1/jd/farm/create/${$.farmInfo.farmUserPro.shareCode}/`}, (err, resp, data) => {
      console.log(`http://api.turinglabs.net/api/v1/jd/farm/create/${$.farmInfo.farmUserPro.shareCode}/`)
      try {
        if (err) {
