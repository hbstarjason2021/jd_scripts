...
[task_local]
#店铺签到
0 0 * * * https://raw.githubusercontent.com/ljqailym/JD/main/dpqd2.js, tag=店铺签到, enabled=true
===========Loon============
[Script]
cron "0 0 * * *" script-path=https://raw.githubusercontent.com/ljqailym/JD/main/dpqd2.js,tag=店铺签到
============Surge=============
...
===========小火箭========
店铺签到 = type=cron,script-path=https://raw.githubusercontent.com/ljqailym/JD/main/dpqd2.js, cronexpr="0 0 * * *", timeout=3600, enable=true
*/
...
let shopname=''
const token=[
 '836965868E3B31E6FAD9E11D51C44E93',//10天10豆5.30
 'B9CA263D630D8DD4D97DE0D21D38A922',//3天100豆4.18  
 '1358217DFF7E683AFDB5EAD29478EB2B',//50豆6.7
]
//IOS等用户直接用NobyDa的jd cookie
