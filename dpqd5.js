...
[task_local]
#店铺签到
0 0 * * * https://raw.githubusercontent.com/ljqailym/JD/main/dpqd5.js, tag=店铺签到, enabled=true
===========Loon============
[Script]
cron "0 0 * * *" script-path=https://raw.githubusercontent.com/ljqailym/JD/main/dpqd5.js,tag=店铺签到
============Surge=============
店铺签到 = type=cron,cronexp="0 0 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/ljqailym/JD/main/dpqd5.js
===========小火箭========
店铺签到 = type=cron,script-path=https://raw.githubusercontent.com/ljqailym/JD/main/dpqd5.js, cronexpr="0 0 * * *", timeout=3600, enable=true
*/
...
let shopname=''
const token=[
 'D61BBCCF72A3682F1CEA02E384547CA7',//2天3豆4.27/3天5豆4.28/4天8豆4.29/5天13豆
 'C1D048C6BDCCFF33583E07F7D2FF1A5D',//2天3豆
]
//IOS等用户直接用NobyDa的jd cookie
