...
[task_local]
#美妆京豆雨
0 0,12-23 * * * https://raw.githubusercontent.com/ljqailym/JD/main/redman_rain_mz.js, tag=美妆京豆雨, enabled=true
===========Loon============
[Script]
cron "0 0,12-23 * * *" script-path=https://raw.githubusercontent.com/ljqailym/JD/main/redman_rain_mz.js,tag=美妆京豆雨
============Surge=============
美妆京豆雨 = type=cron,cronexp="0 0,12-23 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/ljqailym/JD/main/redman_rain_mz.js.js
===========小火箭========
美妆京豆雨 = type=cron,script-path=https://raw.githubusercontent.com/ljqailym/JD/main/redman_rain_mz.js, cronexpr="0 0,12-23 * * *", timeout=3600, enable=true
*/
const $ = new Env('bN2美妆京豆雨');
let allMessage = '';
let bodyList = {
  '20': {
